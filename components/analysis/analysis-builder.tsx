              ...
              <div className="mt-6 space-y-6">
                  ...
                  <div className="space-y-4 rounded-xl border border-white/10 bg-background/80 p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid gap-2 sm:grid-cols-[160px_auto] sm:items-end">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Increase the slope to reward rows further from the baseline more aggressively, or lower it to keep the ramp gentle.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {form.methodId === 'significance-flag' && form.column && significanceFormConfig && (
                  <div className="space-y-4 rounded-xl border border-white/10 bg-background/80 p-4">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Non-significant rows automatically receive the opposite score. Two-sided checks look at both tails; one-sided checks only the selected tail.
                    </p>
                  </div>
                )}
              </div>
