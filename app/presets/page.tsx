...
export default function PresetsPage() {
  ...
  const handleSave = () => {
    ...
    setError(null);
    setFeedback('Preset saved as preset.json.');
  };
    ...
    <main className="mx-auto max-w-4xl px-6 pb-16 pt-16">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="space-y-2">
          ...
          <p className="text-base text-muted-foreground">
            Export the current file names or load a preset JSON to repopulate the account dataset, column dictionary, and
      ...
      <section className="mt-10 grid gap-6">
        ...
        <Card>
          ...
          <CardDescription>
            Review which files are linked to each slot before saving or after loading a preset.
          </CardDescription>
