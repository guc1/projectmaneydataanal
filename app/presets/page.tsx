...
export default function PresetsPage() {
  const { selectedFiles, loadPreset, updateFilePath } = useUploadContext();
    ...
    <main className="mx-auto max-w-4xl px-6 pb-16 pt-16">
      ...
      <section className="mt-10 grid gap-6">
        ...
        <Card>
          ...
          <CardDescription>
            Review or adjust the stored file paths for each slot before saving or after loading a preset. Browsers hide the
            original location for security, so update the paths manually if needed.
          </CardDescription>
